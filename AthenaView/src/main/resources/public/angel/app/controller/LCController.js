 ...
 */
myAppModule.controller('LCController', ["asyncHttp", "tableService", "DataCheckService", "ScopeService", "$routeParams", "$location", "$scope",
    function (asyncHttp, tableService, DataCheckService, ScopeService, $routeParams, $location, $scope) {
        ...
        var handler = {"xinxian": showXX, "liucun": showLC};
